...
function addFollow(userId, vacationId) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, parameters, info, id;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('follow . LOGIC.');
                    sql = "INSERT INTO follows_table (userId, vacationId) \n    VALUES (?,?);";
...
function unFollow(userId, vacationId) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, parameters;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sql = "DELETE FROM follows_table WHERE userId=? AND vacationId=?; ";
                    parameters = [userId, vacationId];
                    return [4 /*yield*/, dal_1.default.execute(sql, parameters)];
                case 1:
                    _a.sent();
