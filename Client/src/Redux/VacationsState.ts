...
export const clearVacations = (): VacationsAction => {
  return {
    type: VacationsActionType.CLEAR_VACATIONS,
  };
};
  ...
  switch (action.type) {
    ...
    case VacationsActionType.FOLLOW:
      ...
      if (indexToFollow >= 0) {
        ...
        newState.vacations[indexToFollow].numOfFollowers =
          newState.vacations[indexToFollow].numOfFollowers + 1;
      }
      break;
    case VacationsActionType.UN_FOLLOW:
      ...
      if (indexToUnFollow >= 0) {
        ...
        newState.vacations[indexToUnFollow].numOfFollowers =
          newState.vacations[indexToUnFollow].numOfFollowers - 1;
      }
      break;
    case VacationsActionType.CLEAR_VACATIONS:
      newState.vacations = [];
      break;
  }
  return newState;
